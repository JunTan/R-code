...
voting6_dem = final_data_no_AK[choose16_dem]

choose16_gop = c(1,2,8)
voting16_gop = final_data_no_AK[choose16_gop]

# Only want education statistic
choose12_dem = c(1,2,14, 19:21)
voting12_dem = final_data_no_AK[ , choose12_dem]

choose12_gop = c(1,2,12, 19:21)
voting12_gop = final_data_no_AK[ , choose12_gop]
...
chooseTest = sample(nTotal, size = 587, replace = FALSE)
