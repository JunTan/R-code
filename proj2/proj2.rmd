...
p = p +
  geom_point(aes(x = all_counties$longitude, y = all_counties$latitude,color = all_counties$party04, alpha = 0.2, size = all_counties$vote_count_gop04 + all_counties$vote_count_dem04))+ scale_size(range = c(0,15))+ scale_color_manual(name = "patry",values = c( "gop" = "red", "dem" = "blue", "tie" = "purple"))+ guides(alpha = FALSE, color = FALSE, size = FALSE) + labs(x = "longitude", y = "latitude", title = "county voting results for 2004 election", color = "party", size = "Vote counts")
p
...
p = p +
  geom_point(aes(x = all_counties$longitude, y = all_counties$latitude,color = all_counties$party08, alpha = 0.2, size = all_counties$vote_count_gop08 + all_counties$vote_count_dem08))+ scale_size( range = c(0,15)) +guides(alpha = FALSE, color = FALSE, size = FALSE) + labs(x = "longitude", y = "latitude", title = "county voting results for 2008 election", color = "party", size = "Vote counts") 
p
