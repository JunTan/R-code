...
data4 = merge(x = data3, y = all_3, by.x = c("county_name", "state_names"), by.y = c("county_name", "state_name"), all = TRUE)
...
choose12_dem = c(1,2,14, 19:37)
voting12_dem = final_data[ , choose12_dem]

choose12_gop = c(1,2,12, 19:37)
