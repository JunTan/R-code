...
big_data_2 = comb_similar_row(big_data)

df_names = names(big_data_2)

final_data = cleanDF(big_data_2, df_names)

df_names = c("state_names")

final_data_no_Al_Haw = cleanDF(big_data_2, df_names, c("alaska", "hawaii"))
```
